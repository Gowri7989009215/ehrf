...
const AuditTrail = () => {
  ...
  const fetchAuditTrail = async () => {
    try {
      setLoading(true);
      const response = await axios.get('/patient/audit');
  ...
  const getActionIcon = (action) => {
    const iconMap = {
      ...
      'CONSENT_GRANT': UserCheck,
      'CONSENT_REVOKE': UserCheck,
      'LOGIN': Activity,
      'LOGOUT': Activity,
      'default': Activity
    };
  ...
  const getActionColor = (action) => {
    const colorMap = {
      'RECORD_UPLOAD': 'text-blue-600 bg-blue-50',
      'RECORD_VIEW': 'text-green-600 bg-green-50',
      'RECORD_DOWNLOAD': 'text-purple-600 bg-purple-50',
      'CONSENT_GRANT': 'text-emerald-600 bg-emerald-50',
      'CONSENT_REVOKE': 'text-red-600 bg-red-50',
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600">
          Complete history of all activities related to your medical records
        </p>
      </div>
        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <ul className="text-sm text-green-800 space-y-1">
              ...
              <li>• You can see exactly who accessed your data and when</li>
              <li>• Audit logs help ensure compliance and detect unauthorized access</li>
            </ul>
          </div>
        </div>
      </div>
